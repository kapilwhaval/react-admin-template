...
export default () => (
    <div className="svgContainer">
        <svg className="mySVG" xmlns="http://www.w3.org/2000/svg"
            ...
            <g className="body">
                <polygon fill="#fff"
                    points="82.8,171.7 100.4,200 118,171.7 136.8,141.5 130.7,138.4 100.4,163 70.1,138.4 64.1,141.5 	" />
                <path fill="#0484AB"
                    d="M3.4,200l12.1-33.9c1.9-4.1,5.1-7.4,9.2-9.2L64,141.4l36.4,58.5L3.4,200z" />
                <path fill="#0484AB"
                    d="M197.4,200l-12.1-33.9c-1.9-4.1-5.2-7.4-9.2-9.2l-39.3-15.5L100.4,200H197.4z" />
                ...
                <path fill="#DF2C2C"
                    d="M127.7,156.9l-20.4,9.4c-3.2-3.9-8.9-4.4-12.7-1.1c-0.4,0.3-0.8,0.7-1.1,1.1l-20.3-9.4v30.8l20.4-9.4c3.2,3.9,8.9,4.4,12.7,1.1c0.4-0.3,0.8-0.7,1.1-1.1l20.4,9.4L127.7,156.9L127.7,156.9z" />
                <g>
                    <path fill="#F9BDBD" d="M108.8,126H92.2c-2.7,0-5.2-1.2-7-3.2l-16-12.7v27.7l31.1,25.3l0,0l31.3-25.3v-27.7l-16,12.7C114.1,124.8,111.5,126,108.8,126z" />
                </g>
            </g>
            <path className="chin" d="M84.1,121.6c2.7,2.9,29.7,2.1,29.2,0.1" fill="none" stroke="#000"
	...
	C121.2,78.3,123.5,75.8,123.5,72.8L123.5,72.8z">
            ...
            <path className="mouth" fill="#F79392"
                d="M84.6,104.7h31.2c0,0,0,9.5-15.6,9.5S84.6,104.7,84.6,104.7z" />
            <path className="nose"
                d="M96.7,82.9h4.7c1.9,0,3,2.2,1.9,3.7l-2.3,3.3c-0.9,1.3-2.9,1.3-3.8,0l-2.3-3.3C93.6,85,94.7,82.9,96.7,82.9z"
                fill="#FBC8C8" />
            <g className="arms" clipPath="url(#armMask)">
                <g className="armL">
                    <path fill="#FBD7D7" stroke="#000000" strokeLinecap="round" strokeLinejoin="round"
                        strokeMiterlimit="10" strokeWidth="0.25"
                        d="M137.8,118.4l-25.5-30.9l30.9-25.7l33.3,24.4L137.8,118.4z" />
                    <path fill="#FBD7D7" stroke="#000000" strokeLinecap="round" strokeLinejoin="round"
                        strokeMiterlimit="10" strokeWidth="0.25" d="M131,72.1l15.4-12.8c2.2-1.8,5.3-1.4,7,0.6c1.8,2.2,1.4,5.3-0.6,7l-8.2,6.8 M165,82.9l15.5-12.8
	...
	c0.7,0.9,0.6,2.1-0.3,2.8l-1.7,1.5C148.2,64.9,145.7,61.9,145.7,61.9z" />
                    <path fill="#0484AB" stroke="#000000" strokeLinecap="round" strokeLinejoin="round"
                        strokeMiterlimit="10" strokeWidth="0.25"
                        d="M139.6,116.9c-31.4,30.8-63.6,63-83.5,77.5l-34.7-41.6c26.3-23,58.4-45,92.5-66.6" />
                </g>
                <g className="armR">
                    <path fill="#FBD7D7" stroke="#000000" strokeLinecap="round" strokeLinejoin="round"
                        strokeMiterlimit="10" strokeWidth="0.25"
                        d="M250.7,117.4l25.5-30.9l-30.9-25.7L212,85.2L250.7,117.4z" />
                    <path fill="#FBD7D7" stroke="#000000" strokeLinecap="round" strokeLinejoin="round"
                        strokeMiterlimit="10" strokeWidth="0.25" d="M257.6,71.1l-15.4-12.8c-2.2-1.8-5.3-1.4-7,0.6c-1.8,2.2-1.4,5.3,0.6,7l8.2,6.8 M223.6,81.9l-15.5-12.8
		...
		c-0.7,0.9-0.6,2.1,0.3,2.8l1.7,1.5C240.3,63.9,242.8,60.9,242.8,60.9z" />
                    <path fill="#0484AB" stroke="#000000" strokeLinecap="round" strokeLinejoin="round"
                        strokeMiterlimit="10" strokeWidth="0.25"
                        d="M249,116.9c31.4,30.8,63.6,63,83.5,77.5l34.7-41.6c-26.3-23-58.4-45-92.5-66.6" />
                </g>
            </g>
        </svg>
    </div>
